...
def process_cb(): # 'process spot' button callback function
    ...
    global id_entry, spot_typeEntry, verify_entry, spot, spot_array
...
def selection_tool(event): # selection tool function (how the points and lines are plotted).
    ...
    # initialize a new Spot object, assuming there isn't already an unprocessed spot currently being processed
    if spot == None:
...
def delete_cb():
    ...
    global spot_array, delete_entry
